...
//  MagicMemories
//
//  Created by Maximiliano Riquelme Vera on 08/03/2022.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if let windowScene:UIWindowScene = scene as? UIWindowScene {
            ...
            let firstViewController = Camera(nibName: "Camera", bundle : nil)
            let rootNavigationController = UINavigationController(rootViewController: firstViewController)
